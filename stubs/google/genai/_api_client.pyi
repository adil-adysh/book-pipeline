...
from google.auth.transport.requests import AuthorizedSession as AuthorizedSession, Request as Request
...
class BaseApiClient:
    ...
    def request_streamed(self, http_method: str, path: str, request_dict: dict[str, object], http_options: HttpOptionsDict | None = None): ...
    ...
    async def async_request_streamed(self, http_method: str, path: str, request_dict: dict[str, object], http_options: HttpOptionsDict | None = None): ...
    def upload_file(self, file_path: str | io.IOBase, upload_url: str, upload_size: int) -> str: ...
